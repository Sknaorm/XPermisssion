...
class StateStub(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    init {
        val ta = context.obtainStyledAttributes(attrs, R.styleable.StateStub)
        isChildSelected = ta.getBoolean(R.styleable.StateStub_selected, false)
        val default = ta.getResourceId(R.styleable.StateStub_default_appearance, -1)
        val selected = ta.getResourceId(R.styleable.StateStub_selected_appearance, -1)
        val unselected = ta.getResourceId(R.styleable.StateStub_unselected_appearance, -1)
